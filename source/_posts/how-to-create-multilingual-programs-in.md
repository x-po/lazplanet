...
I've worked on lozalization for phpBB and some other projects before - mainly in PHP and for my native language [Bangla](https://en.wikipedia.org/wiki/Bengali_language). I think it's kind of a magic, the way an interface changes into some other language. So I thought I would write on how to do the same thing on Lazarus. So here it is.

In the old days, software used to have only one language on its interface. Things have changed since then. Now we like to have English, plus our own language. So, if you are writing a very useful program, it's great to have some of the popular languages on the same program. These days programs are becoming multi-lingual, supporting multiple languages - which is a great way to ensure accessibility for all. Especially for people who can't speak English. So let's get onto it.
...
Let's learn it through a test project first. It will be very easy to learn for you step by step this way. If you're thirsty for more, I've got a full Tutorial Project later on. So buckle up...!
...
![](how-to-create-multilingual-programs-in/i18n-project-settings-.png)
...
![](how-to-create-multilingual-programs-in/i18n-strings-file-created-.png)
...
![](how-to-create-multilingual-programs-in/i18n-save-from-poedit-.png)
...
![](how-to-create-multilingual-programs-in/i18n-mo-file-created-.png)
...
![](how-to-create-multilingual-programs-in/i18n-es-po-created-.png)
...
![](how-to-create-multilingual-programs-in/i18n-es-mo-created-.png)
...
![](how-to-create-multilingual-programs-in/i18n-es-test-translated-.png)
...
![](how-to-create-multilingual-programs-in/i18n-open-cmd-dir-.png)


Now run the executable with **\--lang es**.


![](how-to-create-multilingual-programs-in/i18n-es-run-cmd-.png)


This will show your application in Spanish language:


![](how-to-create-multilingual-programs-in/i18n-es-run-app-.png)
...
Switch to Form view (**F12**). Place 3 **TGroupBox**es on the form. You many want to resize the form accordingly. Change their `Caption` properties to become something like this:


![](how-to-create-multilingual-programs-in/i18n-groupbox-structure-.png)


Now create 2 **TLabel**s, 2 **TEdit**s, 5 **TButton**s and change their `Caption` or `Text` to make them something like this:


![](how-to-create-multilingual-programs-in/i18n-form-layout-.png)


Now let's change their `Name` property into something more meaningful. Change the `Name` of top left button to `BtnMessage`. Change the `Name` of the 3 language buttons to `BtnEnglish`, `BtnSpanish` and `BtnBangla` respectively. Name the 2 **TEdit**s `EdtName` and `EdtCountry`. Then name the button below to `BtnGreet`.
...
![](how-to-create-multilingual-programs-in/i18n-create-po-.png)


Now open the files with poedit, go to **Catalog -> Properties** and make sure the appropriate language is set for each file matching their language code in the filename, then **Save**. This will create `.mo` files for each one.


![](how-to-create-multilingual-programs-in/i18n-mo-created-.png)
...
![](how-to-create-multilingual-programs-in/i18n-run-first-.png)


Then click the language buttons to change language.


![](how-to-create-multilingual-programs-in/i18n-run-lang-change-.png)
