...
Before getting our hands dirty, let's get our basics straight. Before this article, LazPlanet had another article quite similar to this: {% post_link clone-your-form-into-many 'How to clone your forms into many' %}. Be sure to check that out if you're interested.
...
Draw 3 **Tbutton**s side by side. Set **Caption** like below:
```
